...
var LOG_RECTYPE    = 'io.microshare.ubiqod.log';
...
var MS_API_HOST = 'https://api.microshare.io';
...
function logResult(auth, stage, data) {
    ...
    try {
        lib.writeShare(auth, LOG_RECTYPE, record, ['ubiqod', stage]);
    } catch (e) {
        print('Log write failed: ' + e);
    }
}

// NOTE: httpGet is duplicated across hardware robot files (traplinked, taqt, futura).
